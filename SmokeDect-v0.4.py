...
if __name__ == "__main__":
    ...
    while 1:
        ...
        block_width = int(width/CANDIDATE_BLOCK_SIZE)
        block_height = int(height/CANDIDATE_BLOCK_SIZE)
        HSV_V_each_block = []
                ...
                if fgmask_clip.any():
                    ...
                    if (average_S < AVERAGE_S_THRESHOLD):
                        ...
                        if (frame_count > HSV_V_BLOCK_COUNT - 1):
                            HSV_V_50_block = HSV_V_all_block_ndarray[:, int(m/20)]
                        elif (frame_count > 0):
                            HSV_V_50_block = HSV_V_all_block_ndarray[:frame_count, int(m/20)]
